import animeImg from '../../src/img/anime/index.js'
import animeAudio from '../../src/audio/anime/index.js'

const data = [
    {
        name: 'Volleyball',
        audio: animeAudio.volleyball,
        img: animeImg.volleyball,
    ...
    {
        name: 'Tokyo Ghoul',
        audio: animeAudio.tokyoGhoul,
        img: animeImg.tokyoGhoul,
        description: 'The suspense horror/dark fantasy story is set in Tokyo, which is haunted by mysterious "ghouls" who are devouring humans. People are gripped by the fear of these ghouls whose identities are masked in mystery. An ordinary college student name Kaneki encounters Rise, a girl who is an avid reader like him, at the café he frequents. Little does he realize that his fate will change overnight.'
    },
    {
        name: 'Attack on Titan',
        audio: animeAudio.attackOnTitan,
        img: animeImg.attackOnTitan,
    ...
    {
        name: 'Naruto',
        audio: animeAudio.naruto,
        img: animeImg.naruto,
        description: 'On the day of Naruto Uzumaki birth the village of Konoha was attacked by the 9-tailed fox demon. In order to protect the village Naruto\'s father the 4th hokage sacrificed his life and sealed the demon in his new born son. 13 years later Naruto graduates the ninja academy and becomes a shinobi with goal to be the hokage of the village. '
    },
    {
        name: 'The Promised Neverland',
        audio: animeAudio.promisedNeverland,
        img: animeImg.promisedNeverland,
        description: 'The orphans at Grace Field House have only ever known peace. Their home is nice, their bellies stay full, and their caretaker, Mom, loves them very much. But their world turns upside down when the smartest children of the bunch--Emma, Ray, and Norman--learn what horror awaits them on adoption day. Now, their cultivated wit may be their only chance of survival.'
    },
]
